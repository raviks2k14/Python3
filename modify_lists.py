...
print(f"Hello {guest_list[0].title()}, You are invited to the dinner today")
...
print(f"Sorry to say this, {guest_list[1].title()} can't make it to the dinner today")
...
print("Hello Prati, Greeshu, Pavan, I have found a bigger dinner table. U guys hurry up for the dinner.")
